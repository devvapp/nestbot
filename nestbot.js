...
// You need to `npm install` the following dependencies: body-parser, express, request, hackernews-api, node-wit.
//
// 1. npm install --save body-parser express request hackernews-api node-wit
// 2. Download and install ngrok from https://ngrok.com/download
// 3. ./ngrok http 3000
// 4. node nodebot.js
// 5. Subscribe your page to the Webhooks using verify_token and `https://<your_ngrok_io>/webhook` as callback URL.
// 6. Talk to your bot on Messenger!
// 7. Code was developed using wit.ai quickstart
